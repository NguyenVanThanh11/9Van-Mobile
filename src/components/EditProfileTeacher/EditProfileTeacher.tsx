...
import classes from './EditProfileTeacher.module.css';
...
/* @figmaId 5551:2232 */
export const EditProfileTeacher: FC<Props> = memo(function EditProfileTeacher(props = {}) {
  ...
  return (
    <div className={`${resets.clapyResets} ${classes.root}`}>
      ...
      <div className={classes.frame15282}></div>
      ...
      <div onClick={() => { navigate('/giao-vien'); }} className={classes.jamHome}>
        <JamHomeIcon className={classes.icon5} />
      </div>
      <div className={classes.rectangle34}></div>
      <div onClick={() => { navigate('/danh-sach-lop-hoc'); }} className={classes.clarityBookLine}>
        <ClarityBookLineIcon className={classes.icon6} />
      </div>

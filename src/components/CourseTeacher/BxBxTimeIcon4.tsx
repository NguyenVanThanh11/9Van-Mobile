...
const BxBxTimeIcon4 = (props: SVGProps<SVGSVGElement>) => (
  <svg preserveAspectRatio='none' viewBox='0 0 17 13' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
    <path
      ...
      fill='#4F4F4F'
    />
    <path d='M9.19116 3.79167H7.77713V7.04167H12.0192V5.95833H9.19116V3.79167Z' fill='#4F4F4F' />
  </svg>
);

const Memo = memo(BxBxTimeIcon4);
export { Memo as BxBxTimeIcon4 };
